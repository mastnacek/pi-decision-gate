...
export const MODELS_STORE_FILE = join(homedir(), ".pi", "agent", "models-store.json");
...
export let cachedModels: ModelCache | null = null;

export const CACHE_TTL_MS = 15 * 60 * 1000; // 15 minut
 ...
 */
export function scanRecentSessions(days: number = 7): Map<string, { provider: string; id: string; count: number; lastUsed: number }> {
 ...
 */
export function getConfiguredModels(): Array<{ provider: string; id: string }> {
